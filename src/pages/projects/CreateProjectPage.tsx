...
export function CreateProjectPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-5xl space-y-8">
      <Link to="/projects" className="inline-flex items-center gap-2 text-sm text-text-secondary hover:text-text-primary">
        <ArrowLeft size={14} />
        Back to Projects
      </Link>
      ...
      <header>
        ...
        <p className="mt-2 text-lg text-text-secondary">Set up a new workspace for your team’s onboarding.</p>
      </header>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        <Card className="space-y-5 p-6">
          ...
          <Input id="name" name="name" label="Project Name" placeholder="e.g Mobile App Redesign" required />
          ...
          <label htmlFor="repositoryUrl" className="block space-y-2 text-sm">
            <span className="text-xs font-medium text-text-secondary">GitHub Repository (Optional)</span>
            <div className="relative">
              <Link2 size={14} className="pointer-events-none absolute left-3 top-3.5 text-text-secondary" />
              <input
                id="repositoryUrl"
                name="repositoryUrl"
          ...
          <div className="rounded-xl border border-border bg-surface-muted p-4">
            <div className="grid gap-4 lg:grid-cols-[1fr_280px]">
              <div className="space-y-3">
                <Input id="roleTitle" name="roleTitle" label="Job Title" placeholder="e.g Fullstack Developer" />
                <Input
                  id="technologies"
                  name="technologies"
                ...
                />
                <TechnologyChips items={["React", "PostgreSQL", "Node.js"]} />
              </div>
