    ...
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/30 p-4">
      <div
        className={classNames(
          "flex w-full max-w-xl flex-col max-h-[90vh] rounded-2xl border border-border bg-surface p-8 shadow-soft",
          className,
        )}
      >
        <button
        ...
        {subtitle && <p className="-mt-6 mb-8 shrink-0 text-text-secondary">{subtitle}</p>}
